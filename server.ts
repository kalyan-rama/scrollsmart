...
import { executeFullPipeline } from './server/pipeline';
import { DOMAIN_CATEGORIES, DomainCategory, ReelItem } from './src/types';
...
async function startServer() {
  ...
  // Explicit API 404 Handler - prevent falling through to Vite HTML
  app.all('/api/*', (req, res) => {
  ...
  app.listen(PORT, '0.0.0.0', () => {
    console.log(`[ScrollSmart Server] Running at http://0.0.0.0:${PORT}`);
  });
}
